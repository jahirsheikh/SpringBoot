...
public class EmployeeRestController {
    ...
    public ResponseEntity<String> delete(@PathVariable("id")int id){
        ...
        if(exist){
            ...
            return new ResponseEntity<>("Empoloyee is Deleted", HttpStatus.OK);

        }
        return  new ResponseEntity<>("Empoloyee is not exist", HttpStatus.BAD_REQUEST);
    }
